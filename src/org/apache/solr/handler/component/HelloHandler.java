...
public class HelloHandler extends RequestHandlerBase implements SolrCoreAware , PluginInfoInitialized{
  
  protected static Logger log = LoggerFactory.getLogger(HelloHandler.class);
  ...
  public void init(PluginInfo info) {
    log.info("in init " + info.toString());
    init(info.initArgs);
  ...
  public void inform(SolrCore core){
    log.info("in inform " + core.toString());
    

    // Build the component list
    components = new ArrayList<SearchComponent>( 1 );
    DebugComponent dbgCmp = null;
    SearchComponent comp = new HelloHandlerComponent();
    components.add(comp);
  ...
  public String getSource() {
    log.info("com.tcl.sor.extend.HelloHandler");
    return "$URL: https://svn.apache.org/repos/asf/lucene/dev/branches/lucene_solr_4_0/solr/core/src/java/com/tcl/solr/extend/HelloHandler.java $";
  }
}
