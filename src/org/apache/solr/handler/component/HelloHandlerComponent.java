...
public class HelloHandlerComponent extends SearchComponent{
  
  public static final String COMPONENT_NAME = "query";
  
  protected static Logger log = LoggerFactory.getLogger(HelloHandlerComponent.class);
  ...
  private void testfuciton()
  {
    ...
    log.info("took " + ((end - start) / 1000.0));
